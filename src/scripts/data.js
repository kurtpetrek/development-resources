  ...
  tutorialVideos: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "A great YouTube channel for JavaScript, workflows, frameworks and more.",
        linkURL: "https://www.udacity.com"
      },
      {
        title: "Egghead",
  ...
  images: {
    ...
    items: [
      ...
      },
      {
        title: "Unsplash",
        description:
          "Yet another site for free images that can be used for commercial and non-commercial projects.",
